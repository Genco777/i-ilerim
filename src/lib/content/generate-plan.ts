...
function systemPrompt(): string {
  return [
    ...
    '',
    'STORY-KONSISTENZ (KRITISCH):',
    '- Jede Story MUSS thematisch zum Feed-Post DES GLEICHEN TAGES passen',
    '- Die Story ergänzt oder vertieft das Thema des Hauptposts',
    '- Beispiel: Feed-Post über Typografie → Story zeigt Schreibtisch mit Typo-Skizzen',
    '- Beispiel: Feed-Post über Webdesign-Projekt → Story zeigt kurzen Screen-Ausschnitt',
    '- Beispiel: Feed-Post über Frankfurt → Story zeigt Frankfurter Skyline-Impression',
    '- Keine komplett anderen Themen — Story und Feed-Post sind ein Team',
    '',
