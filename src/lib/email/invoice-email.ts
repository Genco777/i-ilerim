...
export function wrapInvoiceHtml(opts: { subject: string; bodyText: string }): string {
  ...
  const content = `
    ...
    <p style="color:${MUTED};font-family:${FONT};font-size:13px;margin:0 0 20px;">Fly &amp; Froth &middot; Rechnung</p>
    ${paragraphs}
