...
function systemPrompt(brandKit: BrandKit): string {
  return [
    ...
    '',
    'Sprache:',
    '- Erkenne die Sprache der Anweisung automatisch.',
    '- Türkische Anweisung → türkische E-Mail.',
    '- Deutsche Anweisung → deutsche E-Mail.',
    '- Englische Anweisung → englische E-Mail.',
    '- Im Zweifel: Sprache der E-Mail-Domain (.de → Deutsch, .com.tr → Türkisch).',
    '',
    'Stilregeln:',
